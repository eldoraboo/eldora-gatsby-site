...
var plugins = [{
  ...
  options: {
    ...
    "cacheDigest": "07f5a193c5a1357203c0389b1002fb71"
  }
}, {
...
function wrapPageElement({
  ...
  var _element$type$Layout;
  const Layout = (_element$type$Layout = element.type.Layout) !== null && _element$type$Layout !== void 0 ? _element$type$Layout : React.Fragment;
